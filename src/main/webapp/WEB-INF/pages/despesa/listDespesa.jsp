				...
				<div class="col-lg-7 div-center">
					...
					<div class="form-group">
						...
						<div class="col-md-3 input-icon">
							<form:input data-provide="datepicker" data-date-format="dd/mm/yyyy" type="text" path="inicio" class="form-control mask_date" />
						</div>
					
						<label class="col-md-2 control-label" for="nome">Fim:</label>
						<div class="col-md-3 input-icon">
							<form:input data-provide="datepicker" data-date-format="dd/mm/yyyy" type="text" path="fim" class="form-control mask_date" />
						</div>
					</div>
